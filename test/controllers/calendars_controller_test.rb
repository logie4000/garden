...
class CalendarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post calendars_url, params: { calendar: { last_frost: @calendar.last_frost, name: @calendar.name } }
    end
  ...
  test "should update calendar" do
    patch calendar_url(@calendar), params: { calendar: { last_frost: @calendar.last_frost, name: @calendar.name } }

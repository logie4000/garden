...
class CropsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crop" do
    assert_difference('Crop.count') do
      post crops_url, params: { crop: { location_id: @crop.location_id, name: @crop.name, start_date: @crop.start_date, transplant: @crop.transplant, transplant_date: @crop.transplant_date } }
    end
  ...
  test "should update crop" do
    patch crop_url(@crop), params: { crop: { location_id: @crop.location_id, name: @crop.name, start_date: @crop.start_date, transplant: @crop.transplant, transplant_date: @crop.transplant_date } }
